        ...
        <table class="table">      
                ...
                <div class="row">
                    <tr>
                        ...
                        <td class="col-md-2">
                            <textarea type="textarea" spellcheck="true"  id="txtarea" placeholder="Output statement" class="form-control" rows="3" name="op1_output[]"  readonly>{{$content->output}}</textarea>
                        </td>
                        <td class="col-md-2">
                            <textarea type="textarea" spellcheck="true" placeholder="Success indicator statement" class="form-control fields" rows = "3" name="op1_success_indicator[]" readonly>{{$content->success_indicator}}</textarea>
                        </td>
                        <td class="col-md-2">
                            <textarea type="textarea" spellcheck="true" placeholder="Actual accomplishment statement" class="form-control" rows="3" name="op1_actual_accomplishments[]" readonly>{{$content->actual_accomplishments}}</textarea>
                        </td>
