...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link rel="stylesheet" media="screen" href="{{ asset('css/printstyle.css') }}">
  </head>
  <body>
    <div class='main'>
      <div class='wrapper'>
       <img class="col-md-12" alt="" src="{{ asset('profile/headerImg.png') }}">
        ...
        <div class='vl1'>
         ...
         <div style="visibility: hidden;">
            ...
            <p class='p5'>
              <b><u>{{$value->first_name}} {{$value->middle_name}} {{$value->last_name}}</u></b>
            </p>
            <p class='ps5'>
              <u><?php
              echo date("M d Y");
            ...
            <div>
              ...
              <tr>
                <td class='tdk' align="center" ><b>{{strtoupper($value->reviewed)}}</b></td>
            ...
            <table width='390px' class='t12'>
              ...
              <tr>
                <td class='tdk' align="center" ><b>{{strtoupper($value->approved)}}</b></td>
                <td class='tdk' align="center" ><b><?php
              echo date("M d Y");
             ?></b></td>
              </tr>
            ...
            <table class='t1' width="100%">
              ...
              @foreach ($operations1 as $data)
                ...
                <tr>
                  ...
                  <td align='center'>{{$data->efficiency}}</td>
                  <td align='center'>{{$data->timeliness}}</td>
          ...
          <table class='table2'>
            ...
            <tr>
              ...
              <th height="80px" width="240px" valign='bottom'><b>{{$value->first_name}} {{$value->middle_name}} {{$value->last_name}}</b></th>
              <th></th>
              <th height="80px" width="240px" valign='bottom'><b>{{$value->reviewed}}</b></th>
              <th></th>
              <th height="80px" width="240px" valign='bottom'><b>{{$value->approved}}</b></th>
              <th></th>
