    ...
    <div class="container container-fluid" id="form-wrapper-A">
        ...
        <table class="table">      
                ...
                <div class="row">
                    ...
                    <tr>
                        <td class="col-md-4">
                            <textarea type="textarea" spellcheck="true"  id="txtarea" placeholder="Output statement" class="form-control"  rows="3" name="op1_output[]" value="<?php echo e($forms->output); ?>"></textarea>
                        </td>
                        <td class="col-md-4">
                        ...
                        <td class="hidden">
                             <?php if(count($forms->id) > 0 ): ?>
                             <input type="hidden" name="form_id" value="<?php echo e($forms->id); ?>">
                             <?php else: ?>
