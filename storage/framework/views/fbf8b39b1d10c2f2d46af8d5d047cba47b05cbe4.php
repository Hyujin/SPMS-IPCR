...
<div class="container-fluid" id="form">
    ...
    <form action="<?php echo e(URL::to('/forms/ipcr/edit')); ?>" method="POST">
    ...
    <div class="container container-fluid" id="form-wrapper-A">
        ...
        <table class="table">      
                ...
                <div class="row">
                    <div class="hidden">
                        ($i = count($forms->output))
                    </div>
                    <tr>
                        <td class="col-md-4">
                            <textarea type="textarea" spellcheck="true"  id="txtarea" placeholder="Output statement" class="form-control"  rows="3" name="op1_output[]" value="<?php echo e($forms->op1_output); ?>"></textarea>
                        </td>
                        <td class="col-md-4">
                        ...
                        <td class="hidden">
                             <?php if(count($form_id) > 0 ): ?>
                             <input type="hidden" name="form_id" value="<?php echo e($forms->form_id); ?>">
                             <?php else: ?>
...
<!--------------------------------------------------------------------------------------------------------------------------->
    ...
    <div class="container-fluid" id="form-wrapper-D"> 
        ...
        <?php else: ?>
            Something went wrong please redirect to dashboard 
        <?php endif; ?>
    </form>
    </div> <!-- container ends -->
</div>
